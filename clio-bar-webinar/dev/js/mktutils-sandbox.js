...
function loadMarketingInformation() {
  ...
  for (var i = 0; i < fields.length; i++) {
    ...
    if ((value != null) && (value != "")) {
      ...
      var marketing_tracker_field_key = jQuery("<input name='marketing_tracker_values[" + i + "][key]' value='" + the_field + "' type='hidden' />");
      var marketing_tracker_field_value = jQuery("<input name='marketing_tracker_values[" + i + "][value]' value='" + the_value + "' type='hidden' />");
      var marketing_tracker_field_source = jQuery("<input name='marketing_tracker_values[" + i + "][source]' value='" + currentURL + "' type='hidden' />");
      jQuery('form').append(marketing_tracker_field_key, marketing_tracker_field_value, marketing_tracker_field_source);
    }
  }
